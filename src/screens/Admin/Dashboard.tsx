...
const Dashboard: React.FC = () => {
  return (
    <div className="flex min-h-screen bg-white">
      {/* Assuming Sidebar is already created and imported */}
      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex justify-between items-center mb-6 ">
          ...
          <div className="flex items-center space-x-4">
            ...
            <FontAwesomeIcon
              icon={faBell}
              className="text-gray-600 cursor-pointer text-xl" // Increased icon size
            />
            {/* Profile and Sign Out Section */}
            <div className="flex items-center space-x-4">
              {/* Profile Image */}
              <img
                src="https://via.placeholder.com/40" // Replace this URL with the actual profile image source
                alt="Profile"
                className="w-10 h-10 rounded-full" // Increased profile image size
              />
              <span className="text-gray-800">John Doe</span>
              <button className="flex items-center text-red-500">
                <FontAwesomeIcon
                  icon={faSignOutAlt}
                  className="text-xl" // Increased icon size
                />
